...
export const copy:CommandDescription = {
  name: 'copy',
  documentation: 'Copies matching series from the parent pipeline to the current.  This is only useful from sub-pipelines.',
  arguments: [{
    name: 'expr',
    type: 'string',
    optional: true,
