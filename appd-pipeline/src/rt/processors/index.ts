...
import { Log10Processor } from "./log10";
...
import { RangeIntersectProcessor } from "./rangeIntersect";
...
registry.add('log10', new Log10Processor());
...
registry.add('rangeIntersect', new RangeIntersectProcessor());