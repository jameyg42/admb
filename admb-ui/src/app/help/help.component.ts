...
import * as defs from '@metlife/appd-pipeline/out/lang/processor-defs';
import { CommandDescription, CommandArgument } from '@metlife/appd-pipeline/out/lang/processor-defs/api';
