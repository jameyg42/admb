...
var grammar = {
    ...
    {"name": "path", "symbols": ["app", "app_delim", "mp", "path$ebnf$1"], "postprocess": ([app,delim,mp,vals])  => ({app: app, delim: delim, path: mp, values: vals})},
    ...
    {"name": "app_delim", "symbols": [{"literal":":"}, /[|/>:~!#^.-_=+]/], "postprocess": d => d[1]},
