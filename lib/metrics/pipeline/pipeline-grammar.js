...
var grammar = {
    ...
    {"name": "s_expr", "symbols": ["ctx", "__", "search"], "postprocess":  ([ctx,,search]) => {
    ...
    {"name": "path", "symbols": ["string"]},
    {"name": "path$ebnf$1", "symbols": []},
    {"name": "path$ebnf$1", "symbols": ["path$ebnf$1", /[^=;>\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "path", "symbols": [/[^\s"]/, "path$ebnf$1", /[^\s="]/], "postprocess": d => [d[0] + d[1].join('') + d[2]]},
    {"name": "ctx", "symbols": ["ctxArgs"], "postprocess": id},
    {"name": "ctxArgs", "symbols": ["ctxArg"], "postprocess": id},
    {"name": "ctxArgs", "symbols": ["ctxArg", "__", "ctxArgs"], "postprocess": ([arg,,args]) => arg.concat(args)},
    {"name": "ctxArg", "symbols": ["namedArg"], "postprocess": ([arg]) => [arg]},
    ...
    {"name": "pipeOp", "symbols": ["pipeOp$string$1"], "postprocess": id},
