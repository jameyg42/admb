...
var grammar = {
    ...
    {"name": "s_expr", "symbols": ["appArg", "__", "search"], "postprocess":  ([app,,search]) => {
        	search.ctx = app;
        	return search;
        } },
    {"name": "appArg$string$1", "symbols": [{"literal":"a"}, {"literal":"p"}, {"literal":"p"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "appArg", "symbols": ["appArg$string$1", "_", {"literal":"="}, "_", "value"], "postprocess": ([name,,,,value]) => ({app:value})},
