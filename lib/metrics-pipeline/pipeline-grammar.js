...
var grammar = {
    ...
    {"name": "path$string$1", "symbols": [{"literal":":"}, {"literal":"|"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "path$ebnf$1", "symbols": ["vals"], "postprocess": id},
    {"name": "path$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "path", "symbols": ["app", "path$string$1", "mp", "path$ebnf$1"], "postprocess": ([app,,mp,vals])  => ({app: app, path: mp, values: vals})},
